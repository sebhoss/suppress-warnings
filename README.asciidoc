...
Replace `${version.suppress-warnings}` with the http://search.maven.org/#search%7Cga%7C1%7Cg%3A{project-group}%20a%3A{project-name}[latest release]. This project follows the http://semver.org/[semantic versioning] guidelines.
